...
- Progress: Execution pipeline now enforces configurable trade throttles via the trading manager, layering scope-aware windows, minimum spacing guards, and countdown metadata so bursty strategies respect governance cooldowns; snapshot payloads now expose remaining trade credits and live `retry_in_seconds` timers documented in operator guides, with regression coverage spanning throttle helpers, trading-manager snapshots, and docs.【F:src/trading/execution/trade_throttle.py†L202-L312】【F:src/trading/trading_manager.py†L333-L454】【F:docs/performance/trading_throughput_monitoring.md†L87-L116】【F:tests/trading/test_trade_throttle.py†L25-L160】【F:tests/trading/test_trading_manager_execution.py†L1730-L1899】
