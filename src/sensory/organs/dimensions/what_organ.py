...
class WhatEngine:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        try:
            ...
            # Explicit Optional typing with guarded initialization
            self.price_action: Optional["PriceActionAnalyzer"] = PriceActionAnalyzer()
    ...
    def _analyze_market_structure(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            lower_highs = highs.diff().lt(0).sum()
            lower_lows = lows.diff().lt(0).sum()
    ...
    def _calculate_structure_strength(self, df: pd.DataFrame) -> float:
        ...
        try:
            ...
            return float(min(max(float(consistency), 0.0), 1.0))
    ...
    def _calculate_signal_strength(self, analysis: Dict[str, Any]) -> float:
        ...
        try:
            ...
            structure_strength = (
                analysis.get("technical_reality", {})
