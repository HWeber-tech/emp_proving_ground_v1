...
- [ ] `[obs]` Attribution coverage â‰¥ **90%** of orders have belief + probes; no Ïƒ explosions (bounded norms). _Progress: AlphaTradeLoopRunner now normalises attribution payloads by skipping diary samples without belief IDs, trimming probe metadata, bounding confidences, and injecting fallback explanations so coverage snapshots stay valid, the trade intent builder reuses the bounded confidence and propagates diary coverage metadata on intents, and TradingManager propagates coverage snapshots across execution, fallback, and risk rejection paths while refusing to count guardrail payloads missing belief or probe identifiers; diary exports show belief IDs plus bounded confidences under the sanitised schema and regression coverage drives executed runs, missing-diary gaps, and incomplete-attribution samples so warnings stay aligned.【F:src/orchestration/alpha_trade_runner.py†L260-L347】【F:src/orchestration/alpha_trade_runner.py†L603-L692】【F:src/orchestration/alpha_trade_runner.py†L1096-L1219】【F:artifacts/diaries/2025/10/19/diary-222520/diary.json†L1-L76】【F:tests/orchestration/test_alpha_trade_runner.py†L243-L316】【F:tests/orchestration/test_alpha_trade_runner.py†L966-L994】【F:src/trading/trading_manager.py†L1542-L1645】【F:src/trading/trading_manager.py†L4042-L4093】【F:tests/trading/test_trading_manager_execution.py†L1179-L1229】_
...
- [ ] **Attribution coverage** â‰¥ 90% (orders with belief + probes + brief explanation). _Progress: Loop runner telemetry now normalises attribution payloads by skipping diary samples without belief IDs, trimming probe metadata, bounding confidences, and injecting fallback explanations so the >90% path stays valid, the intent builder reuses the bounded confidence and propagates diary coverage metadata on intents, and TradingManager propagates coverage snapshots across execution, fallback, and risk rejection paths while refusing to count samples missing belief identifiers or probe status; diary exports show belief IDs plus bounded confidences under the sanitised schema and regression runs drive executed, missing-diary, and incomplete-attribution paths so warnings stay aligned.【F:src/orchestration/alpha_trade_runner.py†L260-L347】【F:src/orchestration/alpha_trade_runner.py†L603-L692】【F:src/orchestration/alpha_trade_runner.py†L1096-L1219】【F:artifacts/diaries/2025/10/19/diary-222520/diary.json†L1-L76】【F:tests/orchestration/test_alpha_trade_runner.py†L261-L316】【F:tests/orchestration/test_alpha_trade_runner.py†L966-L994】【F:src/trading/trading_manager.py†L1542-L1645】【F:src/trading/trading_manager.py†L4042-L4093】【F:tests/trading/test_trading_manager_execution.py†L1179-L1229】_
