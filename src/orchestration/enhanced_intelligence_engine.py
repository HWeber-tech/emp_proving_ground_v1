"""
Contextual Fusion Engine (compatibility shim)
...
The engine produces a synthesis object with attributes checked by tests:
- unified_score, confidence, narrative_text, narrative_coherence
- intelligence_level, dominant_narrative (with .name)
- supporting_evidence, risk_factors, opportunity_factors
"""
