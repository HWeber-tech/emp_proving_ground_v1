...
class SystemVerifier:
    ...
    async def verify_risk_manager(self) -> bool:
        ...
        try:
            ...
            position = {"symbol": "EURUSD", "size": 1000.0, "entry_price": 1.1000}
    ...
    async def verify_strategy_engine(self) -> bool:
        ...
        try:
            ...
            strategy = CoreMovingAverageStrategy(
                "test_engine", ["EURUSD"], {"fast_period": 5, "slow_period": 10}
            )
    ...
    async def verify_strategy_templates(self) -> bool:
        ...
        try:
            ...
            strategy = CoreMovingAverageStrategy(
                "template_test", ["EURUSD", "GBPUSD"], {"fast_period": 10, "slow_period": 20}
            )
    ...
    async def verify_integration(self) -> bool:
        ...
        try:
            ...
            # Register strategy
            strategy = CoreMovingAverageStrategy(
                "integration_test", ["EURUSD"], {"fast_period": 5, "slow_period": 10}
            )
    ...
    def print_summary(self):
        ...
        overall_status = (
            "✅ ALL TESTS PASSED" if self.results["overall"] else "❌ SOME TESTS FAILED"
        )
