...
from sensory.organs.dimensions.base_organ import SensoryOrgan
...
class PriceOrgan(SensoryOrgan):
    ...
    def perceive(self, data: Any) -> SensorySignal:
    ...
    def _calculate_trend_signal(self) -> PriceSignal:
        ...
        confidence = min(float(abs(trend_strength) * 100), 1.0)
        ...
        return PriceSignal(
            ...
            metadata={"short_ma": short_ma, "long_ma": long_ma, "trend_strength": trend_strength},
        )
    ...
    def _calculate_momentum_signal(self) -> PriceSignal:
        ...
        confidence = min(float(abs(roc) * 5), 1.0)
    ...
    def _calculate_volatility_signal(self) -> PriceSignal:
        ...
        normalized_vol = min(float(volatility) * 100.0, 1.0)
        ...
        return PriceSignal(
            ...
            confidence=confidence,
            metadata={"volatility": volatility, "period": 20},
        )

    def _calculate_price_action_signal(self, data: Any) -> PriceSignal:
