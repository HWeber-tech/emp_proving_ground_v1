...
from sensory.dimensions.why.yield_signal import YieldSlopeTracker
    ...
    def _analyze_fundamentals(self, df: "pd.DataFrame") -> dict[str, object]:
        ...
        try:
            return {
                ...
                "central_bank_divergence": self.fundamental_analyzer.analyze_central_bank_divergence(
                    df
                ),
                "economic_calendar_impact": self.fundamental_analyzer.analyze_economic_calendar_impact(
                    df
                ),
            }
        except Exception as e:
