...
- Progress: Execution pipeline now enforces configurable trade throttles via the trading manager, producing throttle posture snapshots and regression coverage that proves bursty strategies are deferred according to governance policy, with dedicated unit tests validating window, cooldown, and retry metadata.【F:src/trading/execution/trade_throttle.py†L1-L266】【F:src/trading/trading_manager.py†L1185-L1415】【F:tests/trading/test_trade_throttle.py†L1-L64】【F:tests/trading/test_trading_manager_execution.py†L1641-L1721】
