...
class MetricsSink(Protocol):
    ...
    def inc_counter(self, name: str, amount: float = ..., labels: Optional[Dict[str, str]] = ...) -> None: ...
    def observe_histogram(self, name: str, value: float, buckets: Optional[List[float]] = ..., labels: Optional[Dict[str, str]] = ...) -> None: ...
