...
async def main():
    ...
    print(f"Sentient Results: {results['sentient']['adaptation']['learning_signal']:.2f} learning signal")
    ...
    print(f"Competitive Results: {results['competitive']['competitors_identified']} competitors identified")
