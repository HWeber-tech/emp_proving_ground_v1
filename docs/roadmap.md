...
- [ ] **Attribution coverage** â‰¥ 90% (orders with belief + probes + brief explanation). _Progress: The loop runner now feeds the trimmed `_build_brief_explanation` output into trade metadata, intents, outcomes, and loop metadata regardless of diary availability, carrying policy/diary ids when present so attribution and coverage snapshots stay aligned.【F:src/orchestration/alpha_trade_runner.py†L266-L390】【F:src/orchestration/alpha_trade_runner.py†L946-L982】【F:src/orchestration/alpha_trade_runner.py†L1002-L1049】 Diaries from 2025-10-20 (e.g., the replay `diary-011424` and counterfactual mirror `counterfactual_diary-010924`) capture the updated attribution block with brief explanations, guardrail probes, and coverage snapshots.【F:artifacts/diaries/2025/10/20/diary-011424/diary.json†L474】【F:artifacts/diaries/2025/10/20/diary-011424/diary.json†L687】【F:artifacts/diaries/2025/10/20/counterfactual_diary-010924/counterfactual_diary.json†L412】【F:artifacts/diaries/2025/10/20/counterfactual_diary-010924/counterfactual_diary.json†L635】 TradingManager now prefers `brief_explanation`, rebuilds attribution from trade outcomes when intents lack it, and enforces coverage counters off the trimmed payloads to keep warning thresholds meaningful.【F:src/trading/trading_manager.py†L3947】【F:src/trading/trading_manager.py†L3953】【F:src/trading/trading_manager.py†L4160】【F:src/trading/trading_manager.py†L4166】【F:src/trading/trading_manager.py†L4180】 Regression coverage exercises execution success, failure, rejection, and missing-diary paths so attribution coverage remains intact across scenarios.【F:tests/orchestration/test_alpha_trade_runner.py†L484-L522】【F:tests/orchestration/test_alpha_trade_runner.py†L1314-L1357】【F:tests/trading/test_trading_manager_execution.py†L1102】【F:tests/trading/test_trading_manager_execution.py†L1163】【F:tests/trading/test_trading_manager_execution.py†L1338】_
