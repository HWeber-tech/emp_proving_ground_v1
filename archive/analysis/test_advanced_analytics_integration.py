#!/usr/bin/env python3
"""
Advanced Analytics Integration Test Suite
Tests the integration of advanced analytics with the live trading system.
"""
...
from trading.live_trading_executor import LiveTradingExecutor, TradingConfig
from trading.ctrader_interface import cTraderInterface
...
class AdvancedAnalyticsIntegrationTest:
    ...
    def __init__(self):
        ...
        logger.info("Advanced Analytics Integration Test Suite initialized")
    
    def run_all_tests(self):
        """Run all integration tests."""
        logger.info("=" * 60)
        logger.info("ADVANCED ANALYTICS INTEGRATION TEST SUITE")
        logger.info("=" * 60)
        
        # Test 1: Advanced Analytics Core Functionality
        self._test_advanced_analytics_core()
        
        # Test 2: Sentiment Analysis Integration
        self._test_sentiment_analysis_integration()
        
        # Test 3: Technical Indicators Integration
        self._test_technical_indicators_integration()
        
        # Test 4: Market Correlation Integration
        self._test_market_correlation_integration()
        
        # Test 5: Comprehensive Analysis Integration
        self._test_comprehensive_analysis_integration()
        
        # Test 6: Live Trading Integration
        ...
        # Test 10: Trading Signal Enhancement
        self._test_trading_signal_enhancement()
        
        # Print results
        self._print_results()
    
    def _test_advanced_analytics_core(self):
        ...
        try:
            ...
            logger.info("✓ Advanced Analytics Core: PASSED")
            
        except Exception as e:
            logger.error(f"✗ Advanced Analytics Core: FAILED - {e}")
            self._log_test_result("Advanced Analytics Core", False)
    
    def _test_sentiment_analysis_integration(self):
        ...
        try:
            ...
            logger.info("✓ Sentiment Analysis Integration: PASSED")
            
        except Exception as e:
            logger.error(f"✗ Sentiment Analysis Integration: FAILED - {e}")
            self._log_test_result("Sentiment Analysis", False)
    
    def _test_technical_indicators_integration(self):
        ...
        try:
            ...
            for symbol in self.test_symbols:
                ...
                assert indicators.obv >= 0, "OBV negative"
            ...
            logger.info("✓ Technical Indicators Integration: PASSED")
            
        except Exception as e:
            logger.error(f"✗ Technical Indicators Integration: FAILED - {e}")
            self._log_test_result("Technical Indicators", False)
    
    def _test_market_correlation_integration(self):
        """Test market correlation integration."""
        logger.info("\n--- Test 4: Market Correlation Integration ---")
        ...
        try:
            ...
            logger.info("✓ Market Correlation Integration: PASSED")
            
        except Exception as e:
            logger.error(f"✗ Market Correlation Integration: FAILED - {e}")
            self._log_test_result("Market Correlation", False)
    
    def _test_comprehensive_analysis_integration(self):
        ...
        try:
            ...
            logger.info("✓ Comprehensive Analysis Integration: PASSED")
            
        except Exception as e:
            logger.error(f"✗ Comprehensive Analysis Integration: FAILED - {e}")
    ...
    def _test_live_trading_integration(self):
        ...
        try:
            ...
            # Test that advanced analytics is initialized
            assert hasattr(executor, 'advanced_analytics'), "Advanced analytics not initialized"
            assert isinstance(executor.advanced_analytics, AdvancedAnalytics), "Invalid advanced analytics type"
            
            # Test advanced analytics method exists
            assert hasattr(executor, '_perform_advanced_analytics'), "Advanced analytics method missing"
            
            # Test method is callable
            assert callable(executor._perform_advanced_analytics), "Advanced analytics method not callable"
            
            logger.info("✓ Live Trading Integration: PASSED")
            self._log_test_result("Live Trading Integration", True)
            
        except Exception as e:
            logger.error(f"✗ Live Trading Integration: FAILED - {e}")
            self._log_test_result("Live Trading Integration", False)
    ...
    def _test_error_handling(self):
        ...
        try:
            ...
            logger.info("✓ Error Handling and Resilience: PASSED")
            
        except Exception as e:
            logger.error(f"✗ Error Handling and Resilience: FAILED - {e}")
    ...
    def _test_real_data_integration(self):
        ...
        try:
            ...
            for symbol in self.test_symbols:
                ...
                real_data = self.data_manager.load_data(symbol, days=self.test_period)
                
                if real_data is not None and not real_data.empty:
                    # Test with real data
                    indicators = self.advanced_analytics.calculate_advanced_indicators(symbol, real_data)
                    correlation = self.advanced_analytics.analyze_market_correlation(symbol, real_data)
                    analysis = self.advanced_analytics.get_comprehensive_analysis(symbol, real_data)
                    
                    # Validate real data results
                    assert indicators is not None, "Real data indicators failed"
                    assert correlation is not None, "Real data correlation failed"
                    assert analysis is not None, "Real data analysis failed"
                    
                    logger.info(f"✓ Real data integration for {symbol}: {len(real_data)} records")
                else:
                    logger.warning(f"⚠ No real data available for {symbol}, using synthetic data")
            
            self._log_test_result("Real Data Integration", True)
            logger.info("✓ Real Data Integration: PASSED")
            
        except Exception as e:
            logger.error(f"✗ Real Data Integration: FAILED - {e}")
            self._log_test_result("Real Data Integration", False)
    
    def _test_trading_signal_enhancement(self):
        """Test trading signal enhancement with advanced analytics."""
        logger.info("\n--- Test 10: Trading Signal Enhancement ---")
        ...
        try:
            ...
            for symbol in self.test_symbols:
                ...
                logger.info(f"✓ Signal enhancement for {symbol}: {signals['overall_signal']} "
                           f"(confidence: {signals['confidence']:.2f})")
            
            self._log_test_result("Trading Signal Enhancement", True)
            logger.info("✓ Trading Signal Enhancement: PASSED")
            
        except Exception as e:
            logger.error(f"✗ Trading Signal Enhancement: FAILED - {e}")
            self._log_test_result("Trading Signal Enhancement", False)
    ...
    def _print_results(self):
        ...
        if self.passed_tests == self.total_tests:
            logger.info("\n🎉 ALL TESTS PASSED! Advanced Analytics Integration is working correctly.")
        else:
...
def main():
    """Run the advanced analytics integration test suite."""
    try:
