...
class TemporalAdvantageSystem:
    ...
    def _calculate_temporal_confidence(self, session_score: float, calendar_impact: Dict, microstructure_timing: Dict) -> float:
    ...
    def _calculate_optimal_entry_window(self, session_score: float, calendar_impact: Dict, microstructure_timing: Dict) -> Tuple[datetime, datetime]:
