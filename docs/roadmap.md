...
- [ ] `[obs]` Attribution coverage â‰¥ **90%** of orders have belief + probes; no Ïƒ explosions (bounded norms). _Progress: AlphaTradeLoopRunner threads diary coverage into trade metadata, intents, and trade outcomes while pruning stale attribution and bounding confidence and feature norms before emission, and TradingManager propagates coverage snapshots across execution, fallback, and risk rejection paths while refusing to count guardrail payloads missing belief or probe identifiers; regression coverage drives executed runs, missing-diary gaps, and incomplete-attribution samples so warnings stay aligned and clamps hold.【F:src/orchestration/alpha_trade_runner.py†L303-L347】【F:src/orchestration/alpha_trade_runner.py†L551-L620】【F:tests/orchestration/test_alpha_trade_runner.py†L243-L316】【F:tests/orchestration/test_alpha_trade_runner.py†L966-L994】【F:src/trading/trading_manager.py†L1542-L1645】【F:src/trading/trading_manager.py†L4042-L4093】【F:tests/trading/test_trading_manager_execution.py†L1179-L1229】_
...
- [ ] **Attribution coverage** â‰¥ 90% (orders with belief + probes + brief explanation). _Progress: Loop runner telemetry threads diary coverage into trade metadata, intents, and trade outcomes while pruning stale attribution and merging guardrail payloads, and TradingManager propagates coverage snapshots across execution, fallback, and risk rejection paths while refusing to count samples missing belief identifiers or probe status; regression runs drive executed, missing-diary, and incomplete-attribution paths so warnings stay aligned.【F:src/orchestration/alpha_trade_runner.py†L303-L347】【F:src/orchestration/alpha_trade_runner.py†L630-L705】【F:tests/orchestration/test_alpha_trade_runner.py†L261-L316】【F:tests/orchestration/test_alpha_trade_runner.py†L966-L994】【F:src/trading/trading_manager.py†L1542-L1645】【F:src/trading/trading_manager.py†L4042-L4093】【F:tests/trading/test_trading_manager_execution.py†L1179-L1229】_
