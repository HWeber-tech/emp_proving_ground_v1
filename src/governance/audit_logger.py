...
class AuditLogger:
    ...
    def log_decision(self, decision_type: str, strategy_id: str, genome_id: str,
    ...
    def log_strategy_registration(self, strategy_id: str, genome_id: str,
                                registration_type: str, metadata: Optional[Dict[str, Any]] = None):
    ...
    def log_compliance_check(self, check_type: str, strategy_id: str,
        ...
        if passed:
            ...
            logger.warning(f"Compliance check failed: {check_type} for {strategy_id} - violations: {violations}")
