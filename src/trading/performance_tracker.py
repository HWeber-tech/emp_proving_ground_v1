...
class PerformanceTracker:
    ...
    def __init__(self, initial_balance: float = 100000.0):
        ...
        logger.info(
            f"Performance tracker initialized with balance: ${initial_balance:,.2f}"
        )
    ...
    def record_trade(self, trade_data: Dict) -> None:
        ...
        if "entry_price" in trade_data and "exit_price" in trade_data:
            ...
            trade_data["return"] = trade_data["pnl"] / (
                trade_data["entry_price"] * trade_data["size"]
            )
    ...
    def update_daily_equity(
        ...
        self.daily_equity.append(
            {"date": date, "equity": equity, "balance": self.current_balance}
        )
    ...
    def _calculate_trading_metrics(self) -> Dict[str, Any]:
        ...
        avg_win = (
            trades_df[trades_df["pnl"] > 0]["pnl"].mean() if winning_trades > 0 else 0.0
        )
        avg_loss = (
