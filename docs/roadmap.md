...
- [ ] `[obs]` Attribution coverage â‰¥ **90%** of orders have belief + probes; no Ïƒ explosions (bounded norms). _Progress: AlphaTradeLoopRunner now collapses rationale text into bounded `_build_brief_explanation` payloads capped at 160 characters, preserves fallback tactic/regime summaries when rationale is empty, and still only attaches bounded confidences when belief metadata or regime state provides them so attribution payloads remain concise without losing coverage context; the trade intent builder continues threading bounded metadata into orders, while TradingManager trims inbound explanations with the same limit before persisting them; diaries still confirm belief IDs, bounded confidences, probes, and explanations land under the sanitised schema with guardrail annotations, and regression coverage drives long-rationale, fallback, executed, partial, and missing-attribution sequences to keep warning semantics steady; TradingManager now normalises attribution payloads across executed, fallback, rejected, and error outcomes before stats updates so coverage metrics stay accurate for non-executed paths, and regression coverage exercises failed and risk-rejected orders to hold attribution coverage at 100% with executed flags cleared.【F:src/orchestration/alpha_trade_runner.py†L241-L347】【F:src/orchestration/alpha_trade_runner.py†L624-L904】【F:artifacts/diaries/2025/10/19/diary-224409/diary.json†L1-L80】【F:artifacts/diaries/2025/10/19/diary-224611/diary.json†L1-L80】【F:tests/orchestration/test_alpha_trade_runner.py†L241-L322】【F:tests/orchestration/test_alpha_trade_runner.py†L940-L1016】【F:src/trading/trading_manager.py†L1504-L1717】【F:src/trading/trading_manager.py†L3891-L3960】【F:tests/trading/test_trading_manager_execution.py†L1112-L1230】_
...
- [ ] **Attribution coverage** â‰¥ 90% (orders with belief + probes + brief explanation). _Progress: Loop runner telemetry now collapses rationale text into `_build_brief_explanation` payloads capped at 160 characters, preserves tactic/regime fallback summaries when rationale is empty, and now copies the trimmed brief explanation onto the attribution envelope so downstream consumers always receive both fields; the intent builder still propagates bounded coverage metadata on intents, and TradingManager now normalises inbound payloads by preferring `brief_explanation`, trimming once, and persisting it alongside the explanation so downstream metrics see consistent brief text; diary exports carry bounded belief snapshots plus guardrail annotations, with coverage-check decision diaries and guard ledger refreshes capturing belief IDs, trimmed explanations, regime confidences, and approvals for promotion-check runs, while tests hammer long-rationale, fallback, executed, failed, rejected, partial, and missing-attribution runs to keep warning semantics steady.【F:src/orchestration/alpha_trade_runner.py†L891-L913】【F:src/orchestration/alpha_trade_runner.py†L1094-L1223】【F:artifacts/diaries/2025/10/19/diary-224409/diary.json†L1-L80】【F:artifacts/diaries/2025/10/19/diary-224611/diary.json†L1-L80】【F:artifacts/diaries/2025/10/19/decision_diary-224059/decision_diary.json†L1-L111】【F:artifacts/diaries/2025/10/19/decision_guard-224059/decision_guard.json†L1-L145】【F:artifacts/ledger_exports/2025/10/19/policy_guard/policy_guard.json†L1-L29】【F:artifacts/ledger_exports/2025/10/19/policy_ledger/policy_ledger.json†L1-L51】【F:tests/orchestration/test_alpha_trade_runner.py†L343-L424】【F:tests/orchestration/test_alpha_trade_runner.py†L940-L1016】【F:src/trading/trading_manager.py†L3942-L3974】【F:src/trading/trading_manager.py†L4098-L4127】【F:tests/trading/test_trading_manager_execution.py†L1070-L1354】_
