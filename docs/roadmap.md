...
- [ ] `[obs]` Attribution coverage â‰¥ **90%** of orders have belief + probes; no Ïƒ explosions (bounded norms). _Progress: AlphaTradeLoopRunner now collapses rationale text into bounded `_build_brief_explanation` payloads and threads the trimmed attribution onto trade metadata, intents, outcomes, and loop metadata even when diaries are missing, stamping policy/diary ids when present so coverage snapshots stay in sync.【F:src/orchestration/alpha_trade_runner.py†L266-L390】【F:src/orchestration/alpha_trade_runner.py†L946-L982】【F:src/orchestration/alpha_trade_runner.py†L1002-L1049】 Diaries from 2025-10-20 (e.g., the replay `diary-011424` and counterfactual mirror `counterfactual_diary-010924`) show the recorded `brief_explanation`, policy ids, guardrail probes, and coverage snapshots under the new schema.【F:artifacts/diaries/2025/10/20/diary-011424/diary.json†L474】【F:artifacts/diaries/2025/10/20/diary-011424/diary.json†L687】【F:artifacts/diaries/2025/10/20/counterfactual_diary-010924/counterfactual_diary.json†L412】【F:artifacts/diaries/2025/10/20/counterfactual_diary-010924/counterfactual_diary.json†L635】 TradingManager normalises `brief_explanation` first, rehydrates attribution from trade outcomes when intents omit it, and keeps coverage counters warned when trimmed payloads are missing.【F:src/trading/trading_manager.py†L3947】【F:src/trading/trading_manager.py†L3953】【F:src/trading/trading_manager.py†L4160】【F:src/trading/trading_manager.py†L4166】【F:src/trading/trading_manager.py†L4180】 Orchestration and trading manager tests now lock the executed, fallback, rejection, failure, and missing-diary paths so attribution coverage stays at 100% in the exercised scenarios.【F:tests/orchestration/test_alpha_trade_runner.py†L484-L522】【F:tests/orchestration/test_alpha_trade_runner.py†L1314-L1357】【F:tests/trading/test_trading_manager_execution.py†L1102】【F:tests/trading/test_trading_manager_execution.py†L1163】【F:tests/trading/test_trading_manager_execution.py†L1338】_
...
- [ ] **Attribution coverage** â‰¥ 90% (orders with belief + probes + brief explanation). _Progress: The loop runner now feeds the trimmed `_build_brief_explanation` output into trade metadata, intents, outcomes, and loop metadata regardless of diary availability, carrying policy/diary ids when present so attribution and coverage snapshots stay aligned.【F:src/orchestration/alpha_trade_runner.py†L266-L390】【F:src/orchestration/alpha_trade_runner.py†L946-L982】【F:src/orchestration/alpha_trade_runner.py†L1002-L1049】 Diaries from 2025-10-20 (e.g., the replay `diary-011424`, counterfactual mirror `counterfactual_diary-010924`, and fresh replay `diary-015240`) capture the updated attribution block with brief explanations, guardrail probes, and coverage snapshots while logging 100% diary coverage under forced-paper guardrails.【F:artifacts/diaries/2025/10/20/diary-011424/diary.json†L474】【F:artifacts/diaries/2025/10/20/diary-011424/diary.json†L687】【F:artifacts/diaries/2025/10/20/counterfactual_diary-010924/counterfactual_diary.json†L412】【F:artifacts/diaries/2025/10/20/counterfactual_diary-010924/counterfactual_diary.json†L635】【F:artifacts/diaries/2025/10/20/diary-015240/diary.json†L474-L507】 TradingManager now prefers `brief_explanation`, rebuilds attribution from trade outcomes when intents lack it, and enforces coverage counters off the trimmed payloads to keep warning thresholds meaningful.【F:src/trading/trading_manager.py†L3947】【F:src/trading/trading_manager.py†L3953】【F:src/trading/trading_manager.py†L4160】【F:src/trading/trading_manager.py†L4166】【F:src/trading/trading_manager.py†L4180】 Regression coverage exercises execution success, failure, rejection, and missing-diary paths so attribution coverage remains intact across scenarios.【F:tests/orchestration/test_alpha_trade_runner.py†L484-L522】【F:tests/orchestration/test_alpha_trade_runner.py†L1314-L1357】【F:tests/trading/test_trading_manager_execution.py†L1102】【F:tests/trading/test_trading_manager_execution.py†L1163】【F:tests/trading/test_trading_manager_execution.py†L1338】
