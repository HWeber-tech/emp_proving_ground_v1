...
class Phase2CValidationSuite:
    ...
    async def run_phase2c_week3a(self) -> Dict[str, Any]:
        ...
        combined_results = {
            ...
            "summary": {
                ...
                "overall_success": (
                    honest_report["success_rate"] >= 0.8 and real_report["success_rate"] >= 0.8
                ),
            },
        }
    ...
    async def run_comprehensive_phase2c(self) -> Dict[str, Any]:
        ...
        comprehensive_report = {
            ...
            "timestamp": datetime.now().isoformat(),
            "weeks": {"week3a": week3a_results, "week3b": week3b_results},
            "summary": {
                "week3a_success": week3a_results["summary"]["overall_success"],
                "week3b_success": week3b_results["summary"]["success_rate"] >= 0.67,  # 2/3 tests
                "overall_success": (
                    week3a_results["summary"]["overall_success"]
                    and week3b_results["summary"]["success_rate"] >= 0.67
                ),
            },
        }
    ...
    def print_comprehensive_report(self, report: Dict[str, Any]) -> None:
        ...
        print(
            f"  Real Market Validation Success: {week3a['real_market_validation']['success_rate']:.1%}"
        )
        print(
            f"  Overall Week 3A Success: {'✅' if week3a['summary']['overall_success'] else '❌'}"
        )
        print()
        ...
        print(
            f"  Tests Passed: {week3b['summary']['passed_tests']}/{week3b['summary']['total_tests']}"
        )
        ...
        print("=" * 120)
        print(
            f"OVERALL PHASE 2C SUCCESS: {'✅ PASSED' if report['summary']['overall_success'] else '❌ FAILED'}"
        )
        print("=" * 120)
